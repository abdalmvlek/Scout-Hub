<?php 
    if(isset($_POST["edit-event"])) {
        ...
        $sql = "UPDATE event SET title = ?, description = ?, start_date = ?, image_path = ? WHERE event_id = ?";
        ...
        if(!mysqli_stmt_prepare($stmt,$sql)) {
            ...
            mysqli_stmt_bind_param($stmt,"ssssi",$title,$description,$startDate,$fullPath,$eventId);
        ...
        header("Location: ../events.php?error=accesesDenied");
    }
